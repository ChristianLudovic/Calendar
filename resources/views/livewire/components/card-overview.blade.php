<div>
    @if($isOpen)
        <div class="bg-[#161618] rounded-[50px] w-full space-y-4 flex flex-col items-center justify-center h-[410px] relative">
            ...
            <div class="text-center">
                ...
                <p class="text-md text-[#6A696A] font-medium">October 14</p>
            </div>
